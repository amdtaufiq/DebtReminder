...
//    private ListView listViewPeminjaman;
    ...
    protected void onStart() {
        ...
        totalLend.setText("Rp. "+String.valueOf(amount));
        ...
        collected.setText("Rp. "+String.valueOf(pay));

        TextView remaining = findViewById(R.id.remaining);
        int result;
        result = amount - pay;
        remaining.setText("Rp. "+String.valueOf(result));
    }
...
//        listViewPeminjaman = findViewById(R.id.list_view_peminjaman);
//        listViewPeminjaman.setAdapter(new PeminjamanListAdapter(this,functionPeminjaman.findAll()));
